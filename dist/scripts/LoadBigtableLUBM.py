...
def loadAllDatasets():
    ...
    datasets = ['lubm500', 'dblp1M', 'dblp10M', 'dblp25M', 'dblp50M', 'dblp100M', 'dblp200M']
    for ds in datasets:
        loadDataset(ds)
...
def loadDataset(dataset):
    ...
    os.popen('hadoop jar ./RDFConverter.jar com.antony_neu.thesis.RDFToCSV.RDFConverter -f 1 /data/lubm/'+dataset+'_r.nt  10 '+dataset)
    ...
    os.popen('hadoop jar ./RDFConverter.jar com.antony_neu.thesis.RDFToCSV.RDFConverter --lubm -f 2 /data/lubm/' + dataset + '_r.nt 10 ' + dataset)
    os.popen('hadoop fs -chmod -R 777 '+dataset)    
