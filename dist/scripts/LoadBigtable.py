...
def loadDataset(dataset):
    ...
    os.popen('hadoop jar ../SempalaLoader.jar sparql2impala.mapreduce.RDFToCSV.RDFConverter -f 1 /data/sp2bench/'+dataset+'.n3  10 '+dataset)
    ...
    os.popen('hadoop jar ../SempalaLoader.jar sparql2impala.mapreduce.RDFToCSV.RDFConverter -f 2 /data/sp2bench/' + dataset + '.n3 10 ' + dataset)
    os.popen('hadoop fs -chmod -R 777 '+dataset)    
